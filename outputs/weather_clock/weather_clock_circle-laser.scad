// Generated by SolidPython 1.1.3 on 2022-12-29 10:55:42
$fn = 50;
						...
						translate(v = [0, 0, -6]) {
							rotate(a = [0, 0, 0]) {
								union() {
									...
									translate(v = [0, 0, 0]) {
										rotate(a = [0, 0, 0]) {
											cylinder(h = 1.7000000000, r1 = 3.0500000000, r2 = 1.6500000000);
										}
									}
								}
							}
